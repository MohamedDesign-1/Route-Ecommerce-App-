...
class WishListRepositoryImpl implements WishListRepository {
  ...
  @override
  Future<Either<Failure, String>> deleteProductFromWishList(String productId) async{
    var either = await wishListRemoteDataSource.deleteProductFromWishList(productId: productId);
    return either.fold((error) => Left(error), (response) => Right(response));
  }
