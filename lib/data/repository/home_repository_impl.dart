...
class HomeRepositoryImpl implements HomeRepository {
  ...
  @override
  Future<Either<Failure, GetCartResponseEntity>> updateNumOfCartInProductDetails(String productId, int count) async{
    var either = await homeRemoteDataSource.updateNumOfCartInProductDetails(productId , count);
    return either.fold((error) => Left(error), (response) => Right(response));
  }

  @override
  Future<Either<Failure, GetWishListResponseEntity>> addToWishList({required String productId}) async {
