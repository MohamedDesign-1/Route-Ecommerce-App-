...
abstract class HomeRepository {
  ...
  Future<Either<Failure , GetCartResponseEntity>> updateNumOfCartInProductDetails(String productId , int count);
  Future<Either<Failure, GetWishListResponseEntity>> addToWishList({required String productId});
