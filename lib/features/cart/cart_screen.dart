    ...
    return Scaffold(
      ...
      builder: (context, state) {
        if (CartViewModelCubit.get(context).productList.isEmpty) {
          return NotHaveItems(icon: Icons.shopping_cart_rounded, message: AppConstants.yourCartIsEmpty,);
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return CartItemCard(cartEntity: state.responseEntity.data!.products![index],);
                  },
                ),
              ),
              Padding(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text('${state.responseEntity.data!.totalCartPrice!} EGP', style: getBoldStyle(color: ColorManager.black, fontSize: FontSizeManager.s18),),
                        ],
                      ),
                      SpinnerButton(
                        onPressed: () {},
