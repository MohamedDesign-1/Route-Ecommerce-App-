                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                      ShortTextUtils.truncateText(cartEntity.product!.title!, 25),
                          style: getBoldStyle(
                        ...
                        CustomIconBtn(
                            ...
                            iconSize: 24.sp,
                            onPressed: (){
                              CartViewModelCubit.get(context).deleteItemInCart(cartEntity.product!.id!);
                            },
                        )
                      ],
                    ),
                          ...
                          child: Row(
                            ...
                            children: [
                              InkWell(
                                  ...
                                  count--;
                                  CartViewModelCubit.get(context).updateCountInCart(cartEntity.product!.id!, count);
                                  },
                                  child: Icon(Icons.remove_circle_outline_rounded , size: 20.w, color: ColorManager.white,)),
                              SizedBox(width: 8.w,),
                              Text('${cartEntity.count!}' , style: getBoldStyle(color: ColorManager.white, fontSize: FontSizeManager.s16.sp),),
                              SizedBox(width: 8.w,),
                              InkWell(
                                  onTap: (){
                                    int count = cartEntity.count!.toInt();
                                  ...
                                  child: Icon(Icons.add_circle_outline_rounded, size: 20.w, color: ColorManager.white,)),
                            ],
                          ),
                        )
                      ],
