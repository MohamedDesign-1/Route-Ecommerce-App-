          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: Image.network(
                  WishlistCubit.get(context).productList[index].imageCover ?? AppConstants.imageUrl,
                  fit: BoxFit.cover,
                ),
              ),
              SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                      ShortTextUtils.truncateText(WishlistCubit.get(context).productList[index].title!, 25),
                          style: getBoldStyle(
                        ...
                        CustomIconBtn(
                            ...
                            iconSize: 24.sp,
                            onPressed: (){
                              WishlistCubit.get(context).deleteFromWishList(WishlistCubit.get(context).productList[index].id!);
                            },
                        )
                      ],
                    ),
